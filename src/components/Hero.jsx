  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        ...
        />
        <div
          className="absolute w-[500px] h-[500px] right-[-100px] top-[-100px] rounded-full"
          style={{
            background:
        ...
        />
        <div
          className="absolute w-[400px] h-[400px] left-[-50px] bottom-[-50px] rounded-full"
          style={{
            background:
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        <div>
          ...
          <div className="flex items-center gap-3 mb-7">
            <span className="font-mono text-lg text-teal">{roleText}</span>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link
              to="/#contact"
              className="px-7 py-3.5 rounded-full bg-white/5 border border-white/10 text-sm text-zinc-300 hover:border-white/20 flex items-center gap-2"
            >
          ...
          <div className="grid grid-cols-5 mt-12 rounded-xl overflow-hidden border border-white/8">
        ...
        <div className="relative flex items-center justify-center">
          <div className="relative w-full max-w-[420px] aspect-[4/5]">
            ...
            <div className="hero-photo-frame absolute inset-0 rounded-3xl overflow-hidden border border-white/15 bg-[#0f0f18] shadow-2xl">
              <div className="hero-photo-slide is-active">
                <iframe
                  src={activePhoto.embedUrl}
                  width="100%"
                  height="100%"
                  frameBorder="0"
                  scrolling="no"
            ...
            <div className="absolute top-[10%] right-[-22px] lg:right-[-82px] px-4 py-3 rounded-xl bg-[#050508]/90 backdrop-blur-xl border border-white/15">
            ...
            <div
              className="absolute bottom-[15%] left-[-22px] lg:left-[-80px] px-4 py-3 rounded-xl bg-[#050508]/90 backdrop-blur-xl border border-white/15"
            >
              <div className="text-[0.6rem] text-zinc-500 uppercase tracking-[2px]">
                Experience
              </div>
            ...
            <div className="absolute left-4 lg:left-[-70px] top-1/2 -translate-y-1/2 flex flex-col gap-3">
              {SOCIAL_LINKS.map(({ href, label, Icon }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-10 h-10 rounded-full bg-white/8 border border-white/10 flex items-center justify-center text-sm hover:bg-amber-400/15 hover:border-amber-400/40 hover:text-amber-400"
                >
